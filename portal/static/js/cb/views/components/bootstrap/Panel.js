...
var _utilsBootstrapUtils = require('../../../../../../../node_modules/react-bootstrap/lib/utils/bootstrapUtils');

var _utilsBootstrapUtils2 = _interopRequireDefault(_utilsBootstrapUtils);

var _styleMaps = require('../../../../../../../node_modules/react-bootstrap/lib/styleMaps');

var _Collapse = require('../../../../../../../node_modules/react-bootstrap/lib/Collapse');
    ...
    renderHeading: function renderHeading(headerRole) {
        ...
        if (!_react2['default'].isValidElement(header) || Array.isArray(header)) {
            ...
            if (this.props.collapsible) {
                ...
                header = <div className="panel-heading item-heading">
                    {header.props.children}
                </div>;
            ...
            if (this.props.collapsible) {
                header = _react.cloneElement(header, {
                    ...
                    children: <div className="item-heading">
                                {this.renderAnchor(header.props.children, headerRole)}
                                {header.props.children}
                              </div>
                });
