...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Client.plaintext_key'
        db.delete_column(u'clients_client', 'plaintext_key')


    def backwards(self, orm):
        # Adding field 'Client.plaintext_key'
        db.add_column(u'clients_client', 'plaintext_key',
