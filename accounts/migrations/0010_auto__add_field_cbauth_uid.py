...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CBAuth.uid'
        db.add_column(u'accounts_cbauth', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='not uid', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CBAuth.uid'
        db.delete_column(u'accounts_cbauth', 'uid')
