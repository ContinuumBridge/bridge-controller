...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CBAuth.polymorphic_ctype'
        db.add_column(u'accounts_cbauth', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_accounts.cbauth_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CBAuth.polymorphic_ctype'
        db.delete_column(u'accounts_cbauth', 'polymorphic_ctype_id')
