...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CBUser', fields ['email']
        db.create_unique(u'accounts_cbuser', ['email'])

        # Deleting field 'CBAuth.old_email'
        db.delete_column(u'accounts_cbauth', 'old_email')


    def backwards(self, orm):
        # Removing unique constraint on 'CBUser', fields ['email']
        db.delete_unique(u'accounts_cbuser', ['email'])

        # Adding field 'CBAuth.old_email'
        db.add_column(u'accounts_cbauth', 'old_email',
