...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CBAuth.password'
        db.delete_column(u'accounts_cbauth', 'password')


    def backwards(self, orm):
        # Adding field 'CBAuth.password'
        db.add_column(u'accounts_cbauth', 'password',
                      self.gf('django.db.models.fields.CharField')(default='not_a_password', max_length=128),
                      keep_default=False)
    ...
    models = {
        ...
        'accounts.cbuser': {
            ...
            'temp_password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'})
        },
        u'auth.group': {
