...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Populate the polymorphic_ctype_id fields of each cb_user
        for cb_user in orm.CBUser.objects.all():
            if not cb_user.polymorphic_ctype_id:
                cb_user.polymorphic_ctype = orm['contenttypes.ContentType'].objects.get(app_label='accounts', model='cbuser')
            cb_user.save()
