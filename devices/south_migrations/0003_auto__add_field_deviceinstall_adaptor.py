...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceInstall.adaptor'
        db.add_column(u'devices_deviceinstall', 'adaptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['adaptors.Adaptor']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceInstall.adaptor'
        db.delete_column(u'devices_deviceinstall', 'adaptor_id')
