...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'devices_device', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_device_creator', null=True, to=orm['cb_account.CBAuth'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user_device_modifier', null=True, to=orm['cb_account.CBAuth'])),
