...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceInstall.friendly_name'
        db.add_column(u'devices_deviceinstall', 'friendly_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceInstall.friendly_name'
        db.delete_column(u'devices_deviceinstall', 'friendly_name')
