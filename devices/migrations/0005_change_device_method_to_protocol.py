...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renames method on a device to protocol
        db.rename_column('devices_device', 'method', 'protocol')
        # Renames mac_addr on a device to address 
        db.rename_column('devices_deviceinstall', 'mac_addr', 'address')

    def backwards(self, orm):
        # Renames protocol on a device to method
        db.rename_column('devices_device', 'protocol', 'method')
        # Renames address on a mac_addr to method
        db.rename_column('devices_deviceinstall', 'address', 'mac_addr')
