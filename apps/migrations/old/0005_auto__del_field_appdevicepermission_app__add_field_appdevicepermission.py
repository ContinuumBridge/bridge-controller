...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppDevicePermission.app'
        db.delete_column(u'apps_appdevicepermission', 'app_id')

        # Adding field 'AppDevicePermission.app_install'
        db.add_column(u'apps_appdevicepermission', 'app_install',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['apps.AppInstall']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AppDevicePermission.app'
        db.add_column(u'apps_appdevicepermission', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['apps.App']),
                      keep_default=False)

        # Deleting field 'AppDevicePermission.app_install'
        db.delete_column(u'apps_appdevicepermission', 'app_install_id')
