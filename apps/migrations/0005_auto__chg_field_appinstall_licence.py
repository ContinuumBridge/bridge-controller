...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AppInstall.licence'
        db.alter_column(u'apps_appinstall', 'licence_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['apps.AppLicence']))

    def backwards(self, orm):

        # Changing field 'AppInstall.licence'
        db.alter_column(u'apps_appinstall', 'licence_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.AppLicence'], null=True))
