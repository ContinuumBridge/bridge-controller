...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppDevicePermission.device_install'
        db.add_column(u'apps_appdevicepermission', 'device_install',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devices.DeviceInstall']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppDevicePermission.device_install'
        db.delete_column(u'apps_appdevicepermission', 'device_install_id')
