...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppDevicePermission.device'
        db.delete_column(u'apps_appdevicepermission', 'device_id')


    def backwards(self, orm):
        # Adding field 'AppDevicePermission.device'
        db.add_column(u'apps_appdevicepermission', 'device',
