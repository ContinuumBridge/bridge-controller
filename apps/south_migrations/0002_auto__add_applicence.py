...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppLicence'
        db.create_table(u'apps_applicence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_apps_applicence_related', null=True, to=orm['accounts.CBAuth'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='modified_apps_applicence', null=True, to=orm['accounts.CBAuth'])),
            ...
            ('installs_permitted', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('apps', ['AppLicence'])


    def backwards(self, orm):
        # Deleting model 'AppLicence'
        db.delete_table(u'apps_applicence')
