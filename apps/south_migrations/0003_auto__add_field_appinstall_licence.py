...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppInstall.licence'
        db.add_column(u'apps_appinstall', 'licence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.AppLicence'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppInstall.licence'
        db.delete_column(u'apps_appinstall', 'licence_id')
