...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Bridge.plaintext_password'
        db.delete_column(u'bridges_bridge', 'plaintext_password')

        # Adding field 'Bridge.key'
        db.add_column(u'bridges_bridge', 'key',
                      self.gf('django.db.models.fields.CharField')(default='not a key', max_length=128),
                      keep_default=False)

        # Adding field 'Bridge.plaintext_key'
        db.add_column(u'bridges_bridge', 'plaintext_key',
                      self.gf('django.db.models.fields.CharField')(default='not a plaintext key', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Bridge.plaintext_password'
        db.add_column(u'bridges_bridge', 'plaintext_password',
                      self.gf('django.db.models.fields.CharField')(default='not a plaintext password', max_length=255),
                      keep_default=False)

        # Deleting field 'Bridge.key'
        db.delete_column(u'bridges_bridge', 'key')

        # Deleting field 'Bridge.plaintext_key'
        db.delete_column(u'bridges_bridge', 'plaintext_key')
