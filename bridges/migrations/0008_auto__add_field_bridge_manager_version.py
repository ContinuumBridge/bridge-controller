...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bridge.manager_version'
        db.add_column(u'bridges_bridge', 'manager_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bridge.manager_version'
        db.delete_column(u'bridges_bridge', 'manager_version')
    ...
    models = {
        ...
        'bridges.bridge': {
            ...
            'manager_version': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
